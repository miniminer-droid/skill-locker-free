...
### The Understanding-First Rule
Don't create cards for material you don't understand. Memorising something you don't understand is useless — you'll forget it quickly, and even if you don't, you can't apply it. If the source material isn't clear, the first step is comprehension (use the ELI5 skill), then create cards.
