...
The hook must do at least one of these:
- Make a surprising claim
- Create an open loop (reader needs to know what happens next)
- Call out a specific person/situation ("If you're still doing X, stop")
- State a concrete number or result
